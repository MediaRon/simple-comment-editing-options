...
class Functions {
	...
	public static function get_settings_url( $tab = '', $sub_tab = '' ) {
		if ( self::is_multisite() ) {
			$options_url = network_admin_url( 'settings.php?page=sce' );
		} else {
			$options_url = admin_url( 'options-general.php?page=sce' );
		}
		if ( ! empty( $tab ) ) {
	...
	public static function get_plugin_slug() {
		return dirname( plugin_basename( SCE_OPTIONS_FILE ) );
	}
	...
	public static function get_plugin_path() {
		return plugin_basename( SCE_OPTIONS_FILE );
	}
	...
	public static function get_plugin_logo() {
		 ...
		 */
		return apply_filters( 'sce_options_plugin_logo_full', self::get_plugin_url( '/images/logo.png' ) );
	}
	...
	public static function get_plugin_author() {
		 ...
		 */
		$plugin_author = apply_filters( 'sce_options_plugin_author', 'MediaRon LLC' );
	...
	public static function get_plugin_author_uri() {
		 ...
		 */
		$plugin_author = apply_filters( 'sce_options_plugin_author_uri', 'https://mediaron.com' );
		return $plugin_author;
	}
	...
	public static function get_plugin_icon() {
		 ...
		 */
		return apply_filters( 'sce_options_plugin_icon', self::get_plugin_url( '/images/logo.png' ) );
	}
	...
	public static function get_plugin_name() {
		 ...
		 */
		return apply_filters( 'sce_options_plugin_name', __( 'Simple Comment Editing Options', 'simple-comment-editing-options' ) );
	}
	...
	public static function get_plugin_description() {
		 ...
		 */
		return apply_filters( 'sce_options_plugin_description', __( 'Allow your users to edit comments.', 'simple-comment-editing-options' ) );
	}
	...
	public static function get_plugin_uri() {
		 ...
		 */
		return apply_filters( 'sce_options_plugin_uri', 'https://mediaron.com/simple-comment-editing-options/' );
	}
	...
	public static function get_plugin_menu_name() {
		 ...
		 */
		return apply_filters( 'sce_options_plugin_menu_name', __( 'Simple Comment Editing', 'simple-comment-editing-options' ) );
	}
	...
	public static function get_plugin_title() {
		 ...
		 * @param string Plugin Menu Name.
		 */
		return apply_filters( 'sce_options_plugin_menu_title', self::get_plugin_name() );
	}
	...
	public static function get_plugin_dir( $path = '' ) {
		$dir = rtrim( plugin_dir_path( SCE_OPTIONS_FILE ), '/' );
	...
	public static function get_plugin_url( $path = '' ) {
		$dir = rtrim( plugin_dir_url( SCE_OPTIONS_FILE ), '/' );
		if ( ! empty( $path ) && is_string( $path ) ) {
			$dir .= '/' . ltrim( $path, '/' );
		}
		return $dir;
